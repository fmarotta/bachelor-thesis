...
\newthought{The lasso\cite{Tibshirani1996}} is another regularisation 
...
\newthought{Elastic net\cite{Zou2005}} combines the best features of 
...
fixed and random effects as predictors of the outcome.

\newthought{Sparse regression models} 

\newthought{Bayesian sparse linear mixed model\cite{Zhou2013}}

\todo{Expand on the last three sections... it doesn't make sense to put 
the ones on the other types of regression, and not these. Also, provide 
references to where these methods are used in the papers.}
