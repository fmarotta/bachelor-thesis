...
success stories, see \reffig{introduction/gwas_success}.
...
times splicing does not alter gene expression, the other mechanisms do, 
suggesting that gene expression is the most important intermediate link 
in the chain of events leading from genome to phenotype.
