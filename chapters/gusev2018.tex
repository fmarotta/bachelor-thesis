...
\marginnote{For these analysis, the MHC region was not considered due to 
its complexity.}
...
by an antibody. In this case, the data came from lynphoblastoid cell 
lines from Yoruban individuals.
%\begin{description}
	%\item[LCL of YRI]
%\end{description}
...
%They did not perform a chromatin-wide association study only because 
