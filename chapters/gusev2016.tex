...
association \todo{through correlation} with a complex trait.\todo{LD is 
taken into account: how? where?}
...
factors.\todo{it doesn't mean it is robust} Nevertheless, pleiotropic 
