...
ultimately due to genetic factors\todo{Non proprio, per es. ci può 
	essere pleiotropia}. However, the method cannot reliably identify 
...
\begin{figure}
	\includegraphics[width=0.8\textwidth]{gusev2016/3-heritable_genes}
...
\begin{figure}
	\includegraphics[width=0.8\textwidth]{gusev2016/4-prediction_accuracy_comparison}
...
z-scores\sidenote{The z-score is the standardised association score and 
	...
	mean.} of the SNPs in a locus are normally-distributed, with mean 0 
...
\todo{Define eGWAS.}. On the whole, TWAS performance was comparable to 
...
\todo{re-read that part of the paper and write some more sentence. 
	Optionally add supplementary fig 17.}
