...
\usepackage[citestyle=authoryear-icomp,bibstyle=authoryear,sorting=none,backend=biber]{biblatex}
\addbibresource{main.bib}
\AtEveryBibitem{\clearfield{url}} % Do not show URL
...
% Title of the book
\title[TWAS: Bridging the Gap between Genome, Transcriptome and 
...
\subfile{chapters/gusev2018_bis.tex}
