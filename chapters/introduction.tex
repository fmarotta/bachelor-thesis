...
regions\sidenote{For instance, 80\% of human genes are shared with the 
	mouse, and 40\% of nucleotides are identical. Source: Emes \etal 
	2003, \textit{Comparison of the genomes of human and mouse lays the 
...
quite heritable and differs in different populations\cite{Gilad2008}.

It has been shown that disease-associated variants often are linked to 
eQTL\cite{Nicolae2010}. However, in general genetic variants can 
...
expression levels through direct mechanisms\cite{Li2016}. Although most 
times splicing does not alter gene expression, the other mechanisms 
do,\todo{recapitulate in conclusions: twas does not detect splicing. 
	however, see gusev2018.} suggesting that gene expression is the most 
important intermediate link in the chain of events leading from genome 
to phenotype.
...
heritability\cite{Manolio2009}. For example, height has an heritability 
of 80\%, but the about 40 loci associated with this trait in 2009, after 
a series of GWA studies involving tens of thousands of people, only 
explained about 5\% of phenotypic variance.
...
\marginnote{Moreover, a sort of dilemma arises: to detect rare variants, 
	...
	mutation rate datum: Kong \etal (2012), \textit{Rate of 
		\textnormal{de novo} mutations and the importance of father’s 
		age to disease risk}.}
