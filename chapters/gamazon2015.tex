...
\begin{marginfigure}
	\includegraphics{gamazon2015/ext-breeders}
	\labfig{breeders}
...
region\sidenote{This region, located on chromosome 6, harbours 421 loci, 
including 252 expressed genes, 139 pseudogenes and 30 transcripts. Many 
of these loci are associated to diseases.} Moreover, some genes were 
associated to multiple diseases\sidenote{In these cases, what determines 
which disease shows up if the expression of that gene is altered in an 
...
reported in \reffig{gamazon2015/7}.
